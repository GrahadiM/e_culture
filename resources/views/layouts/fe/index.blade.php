...
<head>
    ...
    <!-- Import Icon -->
    <link rel="stylesheet" type="text/css" href="{{ asset('fe') }}/css/ionicons.min.css">
    ...
    <nav class="navbar">
        <div class="container">
            <div class="navbar-bars">
                ...
                <a href="index.html" class="navbar-title">{{ config('app.name2', 'Laravel') }}</a>
            </div>
    ...
    <section class="section-explore">
        ...
        <div class="overlay">
            <div class="caption">
                ...
                <img src="{{ asset('fe') }}/img/bali-island.png" alt="Bali Island">
            </div>
        </div>
